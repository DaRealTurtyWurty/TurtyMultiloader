...
names such as `fabric`, whereas releases use Minecraft-qualified artifact IDs such as
`turtymultiloader-fabric-26.1.1`. `settings.gradle` contains substitution rules for all core, gas, and slurry modules.
